...
class User(db.Model):
    ...
    application = db.relationship('Application',backref='user',lazy=True,uselist=False)
...
class Meal(db.Model):
    ...
    date = db.Column(db.DateTime(), default=lambda: datetime.datetime.now(tzinfo))
...
class Product(db.Model):
    ...
    description = db.Column(db.String(16000000),default='<Product Description Text>')
